...
| GET | `/tenants/:id/identity-verifications` | owner | — | checks on that tenant record |
...
5. **Monthly cap**, `IDENTITY_KYC_MONTHLY_CAP` (500 billable calls). Exhausted → `429 { error: 'provider_quota_exceeded' }`.
